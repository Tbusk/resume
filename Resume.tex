...
\begin{document}
    ...
    \rListBeginCircle
        ...
        %\rPlainItem{Reverse-engineered the legacy e-automate SQL Server backend to automate payment reconciliation, processing Stripe webhooks in Java and Spring Boot and recording payments via stored procedures across 20+ tables}
...
%
%    \rListBeginCircle
%        \rPlainItem{Tracked solved competitive programming problems and activity reports across 4 Spring Boot services by building an open-soruce microservices monorepo with Spring Cloud Config, Gateway, Eureka, and Oracle Database}
%    \rListEndCircle
...
%        \rBoldedItemAndDescription{Frameworks}{Spring Boot, Spring Cloud, React}
    % only include relevant keywords to JD
        ...
        \rBoldedItemAndDescription{Backend}{Microsoft SQL Server, MariaDB, PostgreSQL, Spring Boot}
        \rBoldedItemAndDescription{Technologies}{Google Cloud Platform, Amazon Web Services, Docker, GitHub Actions, React, Stripe}
    \rListEndEmpty

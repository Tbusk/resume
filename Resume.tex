...
\begin{document}
    ...
    \rListBeginCircle
        ...
        \rPlainItem{Improved Stripe to ERP reconciliation time 4,500x to 7,500x (3-5 minutes to 40ms) for 100 payments per month by automating posting in a custom e-automate ERP workflow, validated with accountants}
        \rPlainItem{Automated Stripe payment recording into e-automate ERP by reverse-engineering its legacy Microsoft SQL Server backend and writing stored procedures affecting 20+ tables, integrated in the Java and Spring Boot billing portal}
        ...
        \rPlainItem{Improved deployment time by 6x (1 hour to 10 minutes) by establishing CI/CD with GitHub Actions and Docker covering testing, builds, approvals, and deployment to an on-premises Linux VM}
    \rListEndCircle
    ...
    \rListBeginCircle
        \rPlainItem{Unified AD Solutions client billing into a self-serve portal by building a Java, Spring Boot, TypeScript, React, and Microsoft SQL Server application integrated with Stripe and e-automate ERP}
